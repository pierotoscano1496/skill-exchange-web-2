    ...
    <div className="flex min-h-screen flex-col">
      ...
      <Container className="py-24 flex flex-col items-center text-center gap-8">
        ...
        <p className="max-w-[700px] text-lg text-muted-foreground md:text-xl">
          Ofrece tus habilidades o encuentra quien te ayude con esas tareas que necesitas. Desde pasear perros hasta
          arreglar jardines, ¡hay una chambita para todos!
        </p>
      ...
      <section id="como-funciona" className="container py-24">
        <h2 className="text-3xl font-bold tracking-tight text-center mb-12">¿Cómo funciona Chambita?</h2>
          ...
          <Card>
            <CardContent className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-muted-foreground">
                Regístrate y cuéntanos qué sabes hacer. ¿Cocinas rico? ¿Arreglas computadoras? ¡Lo que sea vale!
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col items-center text-center p-6">
              ...
              <CardTitle className="text-xl mb-2">Publica tus chambitas</CardTitle>
              <p className="text-muted-foreground">
                Ofrece tus servicios o busca los que necesitas. Tú decides cuándo, dónde y cuánto cobras.
              </p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col items-center text-center p-6">
              ...
              <p className="text-muted-foreground">
                Recibe pagos seguros por tus servicios y construye tu reputación con buenas reseñas.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="bg-muted/30 py-24">
        <Container>
          <h2 className="text-3xl font-bold tracking-tight text-center mb-12">Chambitas populares</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <Card key={service.name} className="bg-background hover:shadow-md transition-shadow">
      ...
      <Container className="py-24">
        <h2 className="text-3xl font-bold tracking-tight text-center mb-12">Lo que dicen nuestros usuarios</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              quote:
      ...
      <section className="bg-primary text-primary-foreground py-16">
        <Container className="text-center">
          <h2 className="text-3xl font-bold mb-4">¿Listo para empezar tu chambita?</h2>
          <p className="max-w-[600px] mx-auto mb-8">
            Únete a miles de personas que ya están ganando dinero extra con sus habilidades
          </p>
          <Link href="/register">
