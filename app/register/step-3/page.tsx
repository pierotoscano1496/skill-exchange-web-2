...
export default function RegisterStep3Page() {
  ...
  const validateSkillForm = () => {
    ...
    const skillExists = skills.some(
      (s) => s.category === selectedCategory && s.subcategory === selectedSubcategory && s.name === selectedSkill,
    )
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-muted/30">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Agrega las habilidades que quieres ofrecer en Chambita</CardDescription>
        </CardHeader>
            ...
            <>
              ...
              {selectedSkill && (
                <>
                  ...
                  <Button type="button" onClick={addSkill} className="w-full" variant="outline">
