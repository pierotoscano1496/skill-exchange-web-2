...
import { ArrowLeft, ArrowRight, Facebook, Instagram, Linkedin, TwitterIcon as TikTok, Eye, EyeOff } from "lucide-react"
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-muted/30">
      <Card className="w-full max-w-lg">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>Configura tus medios de contacto y conecta tus redes sociales</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="pt-4">
            <h3 className="text-sm font-medium mb-2">Redes sociales (al menos una)</h3>
            {errors.social && <p className="text-sm text-red-500 mb-2">{errors.social}</p>}
