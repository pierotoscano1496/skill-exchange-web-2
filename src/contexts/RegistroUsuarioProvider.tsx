...
export const RegistroUsuarioProvider: React.FC<{
  ...
  const setFechaNacimiento = (fechaNacimiento: string) => {
    ...
    const fechaNacimientoWithTimeZone = new Date(
  ...
  const validateRegistroUsuario = (): boolean => {
    const documentValidation =
      ...
      (usuarioDatos.tipoDocumento === "carnet_extranjeria" &&
        usuarioDatos.carnetExtranjeria);
  ...
  const registrarUsuarioAndSkills = async () => {
    ...
    const usuarioSkillsAsignados = await asignarSkillsToUsuario(
