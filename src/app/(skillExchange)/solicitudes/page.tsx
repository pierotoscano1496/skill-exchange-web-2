...
const getMatchServicioDetails = () => {
    return obtenerUsuarioLogged()
        .then(userLogged => {
            return obtenerDetailsMatchsPrestamistaAndOptionalEstado(userLogged.id, "solicitado");
        });
}
...
export default () => {
    ...
    let matchsServicioSelected: MatchServicioDetailsResponse[] = (matchsServicioDetails as MatchServicioDetailsResponse[])
